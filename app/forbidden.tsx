 ...
 <div className="bg-red-200 text-white h-screen">
      <div className="px-5 py-16 md:px-10 md:py-20">  
       <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
        <h1 className="mb-4 text-4xl text-black font-bold md:text-6xl"> Forbidden </h1>
        <p className="mx-auto mb-5 max-w-xl text-sm text-black font-bold sm:text-base md:mb-6 lg:mb-8"> You are not authorized to access this resource. </p>
